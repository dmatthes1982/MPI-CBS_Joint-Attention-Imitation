...
if ~exist('sessionStr', 'var')
  cfg           = [];
  cfg.subFolder = '08b_mplv/';
  cfg.filename  = 'JAI_d01_08b_mplvGamma';
...
cprintf([0,0.6,0], '<strong>[11] - Averaging over dyads</strong>\n');
fprintf('\n');
...
if avgOverDyads == true
  cfg               = [];
  cfg.path          = strcat(desPath, '08b_mplv/');
  ...
  % 2Hz
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11a_mplvod/');
  cfg.filename    = 'JAI_11a_mplvod2Hz';
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11a_mplvod/');
  cfg.filename    = 'JAI_11a_mplvodTheta';
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11a_mplvod/');
  cfg.filename    = 'JAI_11a_mplvodAlpha';
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11a_mplvod/');
  cfg.filename    = 'JAI_11a_mplvod20Hz';
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11a_mplvod/');
  cfg.filename    = 'JAI_11a_mplvodBeta';
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11a_mplvod/');
  cfg.filename    = 'JAI_11a_mplvodGamma';
  cfg.sessionStr  = sessionStr;
...
if avgOverDyads == true
  cfg             = [];
  cfg.path        = strcat(desPath, '09a_itpc/');
  cfg.session     = str2double(sessionStr);
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11b_itpcod/');
  cfg.filename    = 'JAI_11b_itpcod';
  cfg.sessionStr  = sessionStr;
...
if avgOverDyads == true
  cfg             = [];
  cfg.path        = strcat(desPath, '10a_tfr/');
  cfg.session     = str2double(sessionStr);
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11c_tfrod/');
  cfg.filename    = 'JAI_11c_tfrod';
  cfg.sessionStr  = sessionStr;
...
if avgOverDyads == true
  cfg             = [];
  cfg.path        = strcat(desPath, '10b_pwelch/');
  cfg.session     = str2double(sessionStr);
  ...
  % export the averaged PSD values into a *.mat file
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '11d_pwelchod/');
  cfg.filename    = 'JAI_11d_pwelchod';
  cfg.sessionStr  = sessionStr;
