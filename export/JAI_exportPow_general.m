...
fileList     = dir([srcPath, 'JAI_d*_09b_pwelch_*.mat']);                     % determine all avaible sessions
...
for i = 1:1:numOfFiles
  listOfPart(i) = sscanf(fileList{i}, ['JAI_d%d_09b_pwelch_'  sessionStr... % generate a list of all available numbers of dyads
                                        '.mat']);
end
...
freqNum   = data_pwelch.part1.freq;
...
labelOrig = data_pwelch.part1.label;                                        % extract channel names
...
for dyad = 1:1:numOfFiles
  ...
  if any(~strcmp(data_pwelch.part1.label, labelOrig))
