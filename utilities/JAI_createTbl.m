...
switch type
  case 'settings'
    T = table(1,{'unknown'},0,{'unknown'},{'unknown'},{'unknown'},0,...
              0,{'unknown'},{'unknown'},{'unknown'},0,{'unknown'},...
              {'unknown'},{'unknown'});
    T.Properties.VariableNames = ...
        {'dyad', 'noiChan', 'prestim', 'badChanPart1', 'badChanPart2', ...
         'reference', 'ICAcorrVal1', 'ICAcorrVal2', 'ICAcompPart1', ...
         'ICAcompPart2', 'artMethod', 'artThreshold', 'artRejectPLV', ...
         'artRejectITPC', 'artRejectPow'};
