...
%   cfg.desFolder   = destination folder (default: '/data/pt_01826/eegData/DualEEG_JAI_processedDataCCA/00_settings/')
...
desFolder   = ft_getopt(cfg, 'desFolder', ...
          '/data/pt_01826/eegData/DualEEG_JAI_processedDataCCA/00_settings/');
...
switch type
  case 'settings'
    T = table(1,0,{'unknown'},{'unknown'},0,{'unknown'},0,0,{'unknown'},...
                0,{'unknown'},{'unknown'},{'unknown'});
    T.Properties.VariableNames = ...
        {'dyad', 'prestim', 'badChanPart1', 'badChanPart2', 'fsample', ...
         'reference', 'ICAcorrVal1', 'ICAcorrVal2', 'artMethod', ...
         'artThreshold', 'artRejectPLV', 'artRejectITPC', 'artRejectPSD'};
