...
%   cfg.srcFolder   = source folder (default: '/data/pt_01826/eegData/DualEEG_JAI_processedDataCCA/01_raw/')
...
% Get config options
% -------------------------------------------------------------------------
srcFolder   = ft_getopt(cfg, 'srcFolder', '/data/pt_01826/eegData/DualEEG_JAI_processedDataCCA/01_raw/');
