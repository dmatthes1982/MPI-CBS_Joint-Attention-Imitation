...
cprintf([0,0.6,0], '<strong>[8] - Estimation of Phase Locking Values (PLV)</strong>\n');
fprintf('\n');
...
for i = numOfPart
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08a_plv/');
  cfg.filename    = sprintf('JAI_d%02d_08a_plv2Hz', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08b_mplv/');
  cfg.filename    = sprintf('JAI_d%02d_08b_mplv2Hz', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08a_plv/');
  cfg.filename    = sprintf('JAI_d%02d_08a_plvTheta', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08b_mplv/');
  cfg.filename    = sprintf('JAI_d%02d_08b_mplvTheta', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08a_plv/');
  cfg.filename    = sprintf('JAI_d%02d_08a_plvAlpha', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08b_mplv/');
  cfg.filename    = sprintf('JAI_d%02d_08b_mplvAlpha', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08a_plv/');
  cfg.filename    = sprintf('JAI_d%02d_08a_plv20Hz', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08b_mplv/');
  cfg.filename    = sprintf('JAI_d%02d_08b_mplv20Hz', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08a_plv/');
  cfg.filename    = sprintf('JAI_d%02d_08a_plvBeta', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08b_mplv/');
  cfg.filename    = sprintf('JAI_d%02d_08b_mplvBeta', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08a_plv/');
  cfg.filename    = sprintf('JAI_d%02d_08a_plvGamma', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '08b_mplv/');
  cfg.filename    = sprintf('JAI_d%02d_08b_mplvGamma', i);
  cfg.sessionStr  = sessionStr;
